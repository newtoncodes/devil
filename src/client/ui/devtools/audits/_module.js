...
{WebInspector.SDKObject.call(this,target);this._auditsPanel=auditsPanel;this.target().resourceTreeModel.addEventListener(WebInspector.ResourceTreeModel.EventTypes.Load,this._didMainResourceLoad,this);}
...
{this._auditsPanel.clearResults();},__proto__:WebInspector.SDKObject.prototype};WebInspector.AuditFormatters=function()
{}
...
return;this._auditRunning=auditRunning;this._updateButton();this._toggleUIComponents(this._auditRunning);var target=this._auditController.target();if(this._auditRunning){WebInspector.profilingLock().acquire();this._startAudit();}else{this._stopAudit();WebInspector.profilingLock().release();}},_startAudit:function()
